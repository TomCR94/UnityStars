...
namespace DiffMatchPatch {
  ...
  public class Patch {
    ...
    public override string ToString() {
      ...
      foreach (Diff aDiff in this.diffs) {
        ...
        text.Append(WWW.EscapeURL(aDiff.text,
  ...
  public class diff_match_patch {
    ...
    private List<Diff> diff_lineMode(string text1, string text2,
            ...
            System.Object[] b = diff_linesToChars(text1, text2);
      text1 = (string)b[0];
      text2 = (string)b[1];
    ...
    public string diff_toDelta(List<Diff> diffs) {
      ...
      foreach (Diff aDiff in diffs) {
        switch (aDiff.operation) {
          case Operation.INSERT:
            text.Append("+").Append(WWW.EscapeURL(aDiff.text,
                new UTF8Encoding()).Replace('+', ' ')).Append("\t");
            break;
          case Operation.DELETE:
      ...
      foreach (string token in tokens) {
        ...
        switch (token[0]) {
          case '+':
            ...
            param = WWW.EscapeURL(param, new UTF8Encoding(false, true));
     ...
     *      bool values.
     */
    public System.Object[] patch_apply(List<Patch> patches, string text) {
      if (patches.Count == 0) {
    ...
    public List<Patch> patch_fromText(string textline) {
      ...
      while (textPointer < text.Length) {
        ...
        while (textPointer < text.Length) {
          ...
          line = WWW.EscapeURL(line, new UTF8Encoding(false, true));
          if (sign == '-') {
            // Deletion.
