...
namespace UnityEngine.UI.Extensions
{
	...
	public class BoxSliderEditor : SelectableEditor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			{
				EditorGUILayout.HelpBox("Specify a RectTransform for the slider fill or the slider handle or both. Each must have a parent RectTransform that it can slide within.", UnityEditor.MessageType.Info);
			}
